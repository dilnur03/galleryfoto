...
<body>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <a href="tambah.php" class="btn btn-primary" style="height:3em;width:200px;display:flex;justify-content:center;align-items:center;margin:0px auto;">
...
while ($row = mysqli_fetch_assoc($result)) {
    ...
    echo "<div class='gallery-item' style='position: relative;'>"; // Opening gallery-item div
