...
<head>
    ...
    z-index: 1;
    right: 0; /* Atur posisi dropdown ke kanan */
    top: 100%; /* Geser dropdown ke bawah dari elemen parent */
}
...
<div id="content-wrapper" class="d-flex flex-column">
    ...
    <script>
        function loadEditFotoForm(id) {
            $.ajax({
                url: 'edit.php?id=' + id, // Ubah 'edit.php' sesuai dengan halaman yang akan memuat formulir edit
                type: 'GET',
                success: function(response) {
                    $('#editFotoModalBody').html(response);
