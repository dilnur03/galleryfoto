...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO report (type, UserID, reason, FotoID) VALUES ('foto', '$userID', '$reason', '$fotoID')";
...
<head>
    ...
    <style>
        ...
        select, input[type="submit"] {
            width: calc(100% ); /* Mengurangi lebar select agar sesuai */
            padding: 10px;
            margin-bottom: 10px;
...
<div id="content-wrapper" class="d-flex flex-column">
    ...
    <div id="content">
        ...
        <?php if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_SESSION['FotoID'])): ?>
            <div class="alert alert-success" role="alert">
                Laporan foto berhasil dikirim
            </div>
        <?php endif; ?>
