...
if(isset($_GET['search_submit'])) {
    ...
    $sql = "SELECT * FROM foto WHERE JudulFoto LIKE '%$search_query%' ORDER BY TanggalUnggah DESC";
...
<head>
                ...
                <form class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search" method="GET">
                    <div class="input-group" style='position:relative;left:12em'>
                        <input type="text" class="form-control bg-light border-0 small" placeholder="Search for..."
                            aria-label="Search" aria-describedby="basic-addon2" name="search_query">
    ...
    <div class="photo-container">
        ...
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            // Adding a link to each photo to open a modal
...
<script>
    function openDetailModal(photoID) {
        ...
        window.location.href = 'detail.php?id=' + photoID;
    }
</script>
