...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $insert_query = "INSERT INTO user (username, Email, Nama_Lengkap, Alamat, role) 
                     VALUES ('$username', '$email', '$nama_lengkap', '$alamat', '$role')";

    if (mysqli_query($conn, $insert_query)) {
        // Redirect to datauser.php after successful insertion
